...
function pickDirectory() {
    return electron_1.ipcRenderer.invoke("deskmony:pickDirectory");
}
...
function focusWindow() {
    return electron_1.ipcRenderer.invoke("deskmony:focusWindow");
}
/**
...
function notify(payload) {
    return electron_1.ipcRenderer.invoke("deskmony:notify", payload);
}
function onNotificationClick(callback) {
